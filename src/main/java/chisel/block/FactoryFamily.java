...
public class FactoryFamily extends ChiselBlock {
    public FactoryFamily(BlockBehaviour.Properties props) {
        family = builder("factory")
                ...
                .addVariant("factory_column", props, VariantModelType.TOP_BOTTOM_SIDE)
                ...
                .addVariant("factory_metal_box", props, VariantModelType.TOP_BOTTOM_SIDE)
                ...
                .addVariant("factory_vent", props, VariantModelType.TOP_BOTTOM_SIDE)
