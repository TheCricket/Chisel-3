...
public class TechnicalFamily extends ChiselBlock {
    public TechnicalFamily(BlockBehaviour.Properties props) {
        family = builder("technical")
                ...
                .addVariant("technical_fan_fast", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("technical_fan_fast_transparent", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("technical_fan_malfunction", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("technical_fan_malfunction_slow", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("technical_fan_still", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("technical_fan_still_transparent", props, VariantModelType.TOP_BOTTOM_SIDE)
