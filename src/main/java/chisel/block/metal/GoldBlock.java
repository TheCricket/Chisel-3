...
public class GoldBlock extends ChiselBlock {
    public GoldBlock(BlockBehaviour.Properties props) {
        

        family = builder("gold")
                .addVariant(Blocks.GOLD_BLOCK)
                .addVariant("gold_bad_greggy", props)
                .addVariant("gold_bolted", props)
                .addVariant("gold_caution", props)
                .addVariant("gold_crate", props)
                .addVariant("gold_machine", props)
                .addVariant("gold_scaffold", props)
                .addVariant("gold_thermal", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("gold_125", props)
                .addVariant("gold_adv", props)
                .addVariant("gold_bordered", props)
                ...
                .addVariant("gold_egregious", props)
    ...
    public void addTranslations(LangHelper lang) {
        ...
        lang.addBlock(getVariant("gold_bolted"), "Gold", "Bolted");
        lang.addBlock(getVariant("gold_caution"), "Gold", "Caution");
        lang.addBlock(getVariant("gold_crate"), "Gold", "Crate");
        ...
        lang.addBlock(getVariant("gold_bordered"), "Gold", "Bordered");
        ...
        lang.addBlock(getVariant("gold_crate_light"), "Gold", "Light Crate");
