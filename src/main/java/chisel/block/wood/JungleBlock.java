...
public class JungleBlock extends ChiselBlock {
    public JungleBlock(BlockBehaviour.Properties props) {
        ...
        family = builder("jungle_planks")
                ...
                .addVariant("jungle_planks_braid", props)
                ...
                .addVariant("jungle_planks_encased", props)
                .addVariant("jungle_planks_encased_large", props)
                .addVariant("jungle_planks_encased_smooth", props)
                .addVariant("jungle_planks_large", props)
                .addVariant("jungle_planks_log_cabin", props)
                .addVariant("jungle_planks_paneling", props)
                .addVariant("jungle_planks_shipping", props)
