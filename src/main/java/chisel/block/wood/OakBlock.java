...
public class OakBlock extends ChiselBlock {
    public OakBlock(BlockBehaviour.Properties props) {
        

        family = builder("oak_planks")
                .addVariant(Blocks.OAK_PLANKS)
                .addVariant("oak_planks_braced", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("oak_planks_braid", props)
                ...
                .addVariant("oak_planks_encased", props)
                .addVariant("oak_planks_encased_large", props)
                .addVariant("oak_planks_encased_smooth", props)
                .addVariant("oak_planks_large", props)
                .addVariant("oak_planks_log_cabin", props)
                .addVariant("oak_planks_paneling", props)
                .addVariant("oak_planks_shipping", props)
                .addVariant("oak_planks_smooth", props)
