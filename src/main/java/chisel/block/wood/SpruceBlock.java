...
public class SpruceBlock extends ChiselBlock {
    public SpruceBlock(BlockBehaviour.Properties props) {
        

        family = builder("spruce_planks")
                .addVariant(Blocks.SPRUCE_PLANKS)
                .addVariant("spruce_planks_braced", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("spruce_planks_braid", props)
                ...
                .addVariant("spruce_planks_encased", props)
                .addVariant("spruce_planks_encased_large", props)
                .addVariant("spruce_planks_encased_smooth", props)
                .addVariant("spruce_planks_large", props)
                .addVariant("spruce_planks_log_cabin", props)
                .addVariant("spruce_planks_paneling", props)
                .addVariant("spruce_planks_shipping", props)
    ...
    public void addTranslations(LangHelper lang) {
        ...
        lang.addBlock(getVariant("spruce_planks_log_cabin"), "Spruce Wood Planks", "Log Cabin");
