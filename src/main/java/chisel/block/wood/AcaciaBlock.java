...
public class AcaciaBlock extends ChiselBlock {
    public AcaciaBlock(BlockBehaviour.Properties props) {
        ...
        family = builder("acacia_planks")
                ...
                .addVariant("acacia_planks_encased", props)
                .addVariant("acacia_planks_encased_large", props)
                .addVariant("acacia_planks_encased_smooth", props)
                .addVariant("acacia_planks_large", props)
                .addVariant("acacia_planks_log_cabin", props)
                .addVariant("acacia_planks_paneling", props)
                .addVariant("acacia_planks_shipping", props)
