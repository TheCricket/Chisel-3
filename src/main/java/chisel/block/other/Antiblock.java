...
public class Antiblock extends ChiselBlock {
    public Antiblock(BlockBehaviour.Properties props) {
        ...
        family = builder("antiblock")
                .addVariant("antiblock_black", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_blue", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_brown", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_cyan", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_gray", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_green", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_light_blue", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_light_gray", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_lime", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_magenta", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_orange", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_pink", props, VariantModelType.MULTI_LAYER_CONNECTED)
                .addVariant("antiblock_purple", props, VariantModelType.MULTI_LAYER_CONNECTED)
