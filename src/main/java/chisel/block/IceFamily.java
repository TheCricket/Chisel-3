...
public class IceFamily extends ChiselBlock {
    public IceFamily(BlockBehaviour.Properties props) {
        family = builder("ice")
                ...
                .addVariant("ice_chaotic_bricks", props)
                ...
                .addVariant("ice_jellybean", props)
                ...
                .addVariant("ice_pillar", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("ice_pillar_carved", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("ice_pillar_convex", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("ice_pillar_greek_greek", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("ice_pillar_greek_plain", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("ice_pillar_ornamental", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("ice_pillar_plain_greek", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("ice_pillar_plain_plain", props, VariantModelType.TOP_BOTTOM_SIDE)
                .addVariant("ice_prism", props)
                .addVariant("ice_raw", props)
                .addVariant("ice_road", props)
                .addVariant("ice_slanted", props)
                ...
                .addVariant("ice_twisted", props, VariantModelType.TOP_BOTTOM_SIDE)
