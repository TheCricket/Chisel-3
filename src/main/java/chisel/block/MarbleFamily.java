...
public class MarbleFamily extends ChiselBlock {
    ...
    public void addTranslations(LangHelper lang) {
        ...
        lang.addBlock(getVariant("marble_pillar_carved"), "Marble", "Carved Pillar");
        lang.addBlock(getVariant("marble_pillar_convex"), "Marble", "Convex Pillar");
        lang.addBlock(getVariant("marble_pillar_greek_decor"), "Marble", "Greek Decor Pillar");
        lang.addBlock(getVariant("marble_pillar_greek_greek"), "Marble", "Greek Greek Pillar");
        lang.addBlock(getVariant("marble_pillar_greek_plain"), "Marble", "Greek Plain Pillar");
        lang.addBlock(getVariant("marble_pillar_normal"), "Marble", "Normal Pillar");
        lang.addBlock(getVariant("marble_pillar_normal2"), "Marble", "Normal 2 Pillar");
        lang.addBlock(getVariant("marble_pillar_ornamental"), "Marble", "Ornamental Pillar");
        lang.addBlock(getVariant("marble_pillar_plain_decor"), "Marble", "Plain Decor Pillar");
        lang.addBlock(getVariant("marble_pillar_plain_greek"), "Marble", "Plain Greek Pillar");
        lang.addBlock(getVariant("marble_pillar_plain_plain"), "Marble", "Plain Plain Pillar");
        lang.addBlock(getVariant("marble_pillar_rough"), "Marble", "Rough Pillar");
        lang.addBlock(getVariant("marble_pillar_simple"), "Marble", "Simple Pillar");
        lang.addBlock(getVariant("marble_pillar_wide_decor"), "Marble", "Wide Decor Pillar");
        lang.addBlock(getVariant("marble_pillar_wide_greek"), "Marble", "Wide Greek Pillar");
        lang.addBlock(getVariant("marble_pillar_wide_plain"), "Marble", "Wide Plain Pillar");
