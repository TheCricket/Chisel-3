...
public class CobblestoneBlock extends ChiselBlock {
    public CobblestoneBlock(BlockBehaviour.Properties props) {
        ...
        family = builder("cobblestone")
                ...
                .addVariant("cobblestone_tiles_large", props)
