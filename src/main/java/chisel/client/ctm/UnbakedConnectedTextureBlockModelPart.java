...
public record UnbakedConnectedTextureBlockModelPart(
    ...
    public static final MapCodec<UnbakedConnectedTextureBlockModelPart> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    Identifier.CODEC.fieldOf("model_location").forGetter(UnbakedConnectedTextureBlockModelPart::modelLocation),
                    ELEMENT_CODEC.fieldOf("element").forGetter(UnbakedConnectedTextureBlockModelPart::element),
                    Direction.CODEC.listOf().fieldOf("connected_faces").forGetter(m -> m.connectedFaces().stream().toList()),
                    Codec.BOOL.optionalFieldOf("render_overlay_on_all_faces", false).forGetter(UnbakedConnectedTextureBlockModelPart::renderOverlayOnAllFaces),
                    Variant.CODEC.fieldOf("variant").forGetter(UnbakedConnectedTextureBlockModelPart::variant),
                    Codec.INT.optionalFieldOf("base_tint_index", -1).forGetter(UnbakedConnectedTextureBlockModelPart::baseTintIndex),
                    Codec.INT.optionalFieldOf("base_emissivity", 0).forGetter(UnbakedConnectedTextureBlockModelPart::baseEmissivity),
                    Codec.INT.optionalFieldOf("tint_index", -1).forGetter(UnbakedConnectedTextureBlockModelPart::tintIndex),
                    Codec.INT.optionalFieldOf("emissivity", 0).forGetter(UnbakedConnectedTextureBlockModelPart::emissivity)
                    ...
                    new UnbakedConnectedTextureBlockModelPart(modelLocation, element, Set.copyOf(connectedFaces), renderOverlayOnAllFaces, variant, baseTintIndex, baseEmissivity, tintIndex, emissivity))
    );
    ...
    public BlockStateModelPart bake(ModelBaker baker) {
        ...
        ModelData modelData = ModelData.builder().build();
        return new ConnectedTextureBlockModelPart(
                ...
                false, // Ambient occlusion is generally disabled for CTM to avoid shading issues on overlays
