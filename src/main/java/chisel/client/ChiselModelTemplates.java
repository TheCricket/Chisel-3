...
public class ChiselModelTemplates extends ModelTemplates {
    ...
    public static final ModelTemplate CTM_MULTIBLOCK_2x2_WATER = create("chisel:ctm_multiblock_2x2_water", PARTICLE, ALL, LAYER1, CTM_OVERLAY_2X2).extend().parent(Identifier.withDefaultNamespace("block/cube_all")).build();
    public static final ModelTemplate CTM_MULTIBLOCK_3x3_WATER = create("chisel:ctm_multiblock_3x3_water", PARTICLE, ALL, LAYER1, CTM_OVERLAY_3X3).extend().parent(Identifier.withDefaultNamespace("block/cube_all")).build();
    public static final ModelTemplate CTM_MULTIBLOCK_4x4_WATER = create("chisel:ctm_multiblock_4x4_water", PARTICLE, ALL, LAYER1, CTM_OVERLAY_4X4).extend().parent(Identifier.withDefaultNamespace("block/cube_all")).build();
    ...
    public static final ModelTemplate CTM_HORIZONTAL_MULTI_PASS = create("chisel:ctm_horizontal_multi_pass", PARTICLE, TOP, BOTTOM, SIDE, LAYER0, CTM_BASE, CTM_OVERLAY_HORIZONTAL).extend().parent(Chisel.prefix("block/cube_multi_pass_top_bottom_side")).build();
