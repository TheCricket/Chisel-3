...
public class NVDungeonStoneVindictaFamily extends ChiselFamily {
    public NVDungeonStoneVindictaFamily(BlockBehaviour.Properties props) {
        family = builder("nv_dungeon_stone_vindicta")
