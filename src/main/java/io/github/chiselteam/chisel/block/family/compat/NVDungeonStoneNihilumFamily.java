...
public class NVDungeonStoneNihilumFamily extends ChiselFamily {
    public NVDungeonStoneNihilumFamily(BlockBehaviour.Properties props) {
        family = builder("nv_dungeon_stone_nihilum")
