...
public class NVDungeonStoneInvictusFamily extends ChiselFamily {
    public NVDungeonStoneInvictusFamily(BlockBehaviour.Properties props) {
        family = builder("nv_dungeon_stone_invictus")
