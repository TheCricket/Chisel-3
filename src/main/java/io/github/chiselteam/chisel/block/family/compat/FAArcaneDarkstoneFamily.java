...
public class FAArcaneDarkstoneFamily extends ChiselFamily {
    public FAArcaneDarkstoneFamily(BlockBehaviour.Properties props) {
        family = builder("fa_arcane_darkstone")
