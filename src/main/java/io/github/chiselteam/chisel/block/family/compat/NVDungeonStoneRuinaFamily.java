...
public class NVDungeonStoneRuinaFamily extends ChiselFamily {
    public NVDungeonStoneRuinaFamily(BlockBehaviour.Properties props) {
        family = builder("nv_dungeon_stone_ruina")
