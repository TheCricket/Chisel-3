...
import io.github.chiselteam.chisel.menu.slot.ChiselInputSlot;
...
public class ChiselMenu extends AbstractContainerMenu {
    ...
    public void selectVariant(Player player, int selectionIndex, boolean bulk) {
        ...
        VariantFamily family = VariantFamilyLookup.getFamilyForBlock(inputItem.getBlock(), player.level().registryAccess());
