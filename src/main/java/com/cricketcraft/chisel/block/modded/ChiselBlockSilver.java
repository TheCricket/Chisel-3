...
public class ChiselBlockSilver extends BlockCarvableMetal implements IChiselBlock {
    ...
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, ChiselProperties.SILVER_VARIANTS/**, CONNECTS_NORTH, CONNECTS_SOUTH, CONNECTS_EAST, CONNECTS_WEST, CONNECTS_UP, CONNECTS_DOWN*/);
    }
}
